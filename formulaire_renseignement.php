<form action='accueil.php' methode='GET'>
    ...
    <p>Nom : <input type="text" name="nom" required="required" placeholder="Ex: Gharbi" /></p>

    <p>prenom : <input type="text" name="prenom" required="required" placeholder="Ex: Redwan" /></p>

    <p>Date de Naissance : <input type="date" name="dateN" required="required" value="<?php echo $today ?>">

    <p>Numéro de Téléphone : <input type="text" name="tel" required="required" placeholder="Ex: 0768716784" /></p>

    <!-- <p>Sexe : <select name="sexe" required="required">
            <option value="1">Homme</option>
            <option value="2">Femme</option>
            <option value="3">autre</option>
        </select> -->
    <p>Pays : <input type="text" name="Pays" required="required" value="France" /></p>

    <p>Ville : <input type="text" name="Ville" required="required" placeholder="Ex: Nice" /></p>

    <p>Code Postale : <input type="text" name="Code Postale" required="required" /></p>
